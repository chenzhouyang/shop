...
public class ShoppingCartAdapter extends BaseAdapter {
    private List<ShoppingCartEntity.DataBean.ItemsBean> shoppingCartBeanList;
    ...
    public void setShoppingCartBeanList(List<ShoppingCartEntity.DataBean.ItemsBean> shoppingCartBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_shopping_orchard_cart, parent, false);
            holder = new ViewHolder(convertView);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }
        final ShoppingCartEntity.DataBean.ItemsBean shoppingCartBean = shoppingCartBeanList.get(position);
        holder.tv_commodity_name.setText(shoppingCartBean.name);
        holder.tv_spec.setText("规格："+shoppingCartBean.specs==null?"":shoppingCartBean.specs);
        holder.tv_price.setText("￥" + String.format("%.2f", NumberFormat.convertToDouble(shoppingCartBean.price,0.00)));
        ...
        holder.et_show_num.setText(shoppingCartBean.num + "");
        GlideImage.loadImage(context,holder.iv_show_pic,shoppingCartBean.imageDefault,R.mipmap.img_error);
        //单选框按钮
        ...
        //跳转商品详情
        holder.shopping_cart_rl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                modifyCountInterface.skip(position,shoppingCartBean.goodsId);
            }
        });
    ...
    class ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            shopping_cart_rl = (RelativeLayout) itemView.findViewById(R.id.shopping_cart_rl);
        }
    }
    /**
     * 复选框接口
